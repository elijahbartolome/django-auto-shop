...
from customers.models import Inquiry, Customer, Vehicle
...
class ServiceMixin:
    ...
    @classmethod
    def create_service_(cls, name="Quantum Mirror Assessment", duration=timedelta(hours=1),
...
class InquiryMixin:
    ...
    @classmethod
    def create_inquiry_(cls):
        customer = Customer.objects.create(
            name='Elijah',
            phone_number='1234567890',
            email='ebazn123@gmail.com'
        )
        vehicle =  Vehicle.objects.create(
            vin='5J8YD4H36JL008313'
        )
...
class AppointmentRequestMixin:
    ...
    @classmethod
    def create_appointment_request_(cls, service, staff_member, inquiry, date_=date.today(), start_time=time(9, 0),
                                    end_time=time(10, 0)):
...
class AppointmentMixin:
    ...
    @classmethod
    def create_appointment_(cls, appointment_request, phone="+12392340543"):

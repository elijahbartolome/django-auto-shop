...
class BaseTest(TestCase, UserMixin, StaffMemberMixin, ServiceMixin, AppointmentRequestMixin,
               AppointmentMixin, AppointmentRescheduleHistoryMixin, InquiryMixin):
    service1 = None
    service2 = None
    staff_member1 = None
    staff_member2 = None
    ...
    def setUpTestData(cls):
        ...
        cls.service1 = cls.create_service_(
            name="Stargate Activation", duration=timedelta(hours=1), description="Activate the Stargate")
        cls.service2 = cls.create_service_(
            name="Dial Home Device Repair", duration=timedelta(hours=2), description="Repair the DHD")
        ...
        cls.inquiry = cls.create_inquiry_()
    ...
    def create_appt_request_for_sm1(self, service=None, staff_member=None, inquiry=None, **kwargs):
        ...
        return self.create_appointment_request_(service=service, staff_member=staff_member, inquiry=inquiry, **kwargs)

    def create_appt_request_for_sm2(self, service=None, staff_member=None, inquiry=None, **kwargs):
    ...
    def create_appt_for_sm1(self, appointment_request=None):
        ...
        return self.create_appointment_(appointment_request=appointment_request)

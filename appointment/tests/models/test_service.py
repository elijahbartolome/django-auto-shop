...
class ServiceRepresentationAndMiscTests(BaseTest):
    ...
    def test_string_representation_of_service(self):
        ...
        service = Service.objects.create(name=service_name, duration=timedelta(hours=1))
    ...
    def test_image_url_with_attached_image(self):
        ...
        service = Service.objects.create(name="Service with Image", duration=timedelta(hours=1), image=image)
    ...
    def test_image_url_without_attached_image(self):
        ...
        service = Service.objects.create(name="Gate Travel Coordination", duration=timedelta(hours=1))
    ...
    def test_auto_generation_of_background_color(self):
        ...
        service = Service.objects.create(name="Wormhole Stability Analysis", duration=timedelta(hours=1))
    ...
    def test_service_to_dict_representation(self):
        ...
        service = Service.objects.create(name="Off-world Tactical Training", duration=timedelta(hours=1), 
    ...
    def test_reschedule_features(self):
        ...
        service = Service.objects.create(name="Goa'uld Artifact Decryption", duration=timedelta(hours=1),
...
class ServiceModelNegativeTestCase(BaseTest):
    ...
    def test_zero_or_negative_duration_handling(self):
        ...
        service = Service(name="Zat'nik'tel Tune-Up", duration=timedelta(0), description="Tune-up the Zat")
        self.assertRaises(ValidationError, service.full_clean)
        service = Service(name="Ancient's Archive Retrieval ", duration=timedelta(seconds=-1), 
    ...
    def test_creation_without_service_name(self):
        ...
        with self.assertRaises(ValidationError):
            Service.objects.create(name="", duration=timedelta(hours=1)).full_clean()

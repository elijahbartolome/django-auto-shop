...
from appointment.utils.db_helpers import (
    Appointment, AppointmentRequest, EmailVerificationCode, Service, StaffMember, WorkingHours, Inquiry, calculate_slots,
...
def prepare_appointment_display_data(user, appoint_id):
    ...
    """
    appointment = get_appointment_by_id(appoint_id)
...
def save_appointment(appt, client_name, client_email, start_time, phone_number, service_id, request,
    ...
    inquiry.customer.name = client_name
    inquiry.customer.email = client_email
    inquiry.customer.phone_number = phone_number
    inquiry.customer.save()
...
def create_new_appointment(data, request):
    ...
    appointment_data = {
        ...
        'inquiry': appointment_request.inquiry
    }

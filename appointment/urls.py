...
admin_urlpatterns = [
    ...
    path('display-appointment/<str:appoint_id>/', display_appointment, name='display_appointment'),
...
urlpatterns = [
    # homepage
    path('request/<int:service_id>/<str:inquiry_id>', appointment_request, name='appointment_request'),
    path('request-submit/', appointment_request_submit, name='appointment_request_submit'),
    path('appointment/<str:ar_id>/reschedule/', prepare_reschedule_appointment,
    ...
    path('client-info/<str:ar_id>/', appointment_client_information,
         name='appointment_client_information'),
    path('verification-code/<str:ar_id>/<str:inquiry_id>/', enter_verification_code,
         name='enter_verification_code'),
    path('verification-code/', email_change_verification_code, name='email_change_verification_code'),
    path('thank-you/<str:appoint_id>/', default_thank_you, name='default_thank_you'),

...
body.on('click', '.btn-submit-appointment', function () {
    ...
    if (selectedSlot && selectedDate) {
        ...
        if (!form.find('input[name="ar_id"]').length) {
            form.append($('<input>', {
                type: 'hidden',
                name: 'ar_id',
        ...
        form.append($('<input>', {type: 'hidden', name: 'service_id', value: serviceId}));
        form.append($('<input>', {type: 'hidden', name: 'inquiry_id', value: appointmentInquiryId}));

...
def send_thank_you_email(ar: AppointmentRequest, request, email: str, appointment_details=None,
                         account_details=None, inquiry_id=None):
    ...
    relative_reschedule_url = reverse('appointment:prepare_reschedule_appointment', args=[ar.ar_id])
    reschedule_link = get_absolute_url_(relative_reschedule_url, request)

    email_context = {
        'first_name': ar.inquiry.customer.name,
